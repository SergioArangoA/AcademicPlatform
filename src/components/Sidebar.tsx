            ...
            <>
              ...
              <div>
                ...
                <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  <li>
                    <NavLink to="/teachers/evaluations/list" className={`group relative flex items-center gap-2.5 py-2 px-4 text-[13px] duration-300 ease-in-out hover:bg-[#EDE9FE] hover:text-[#6D28D9] dark:hover:bg-meta-4 ${pathname.includes('/teachers/evaluations') ? 'bg-[#EDE9FE] text-[#6D28D9] border-l-[3px] border-[#6D28D9] font-semibold' : 'text-[#374151] font-medium dark:text-bodydark1'}`}>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
