              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                <li>
                  <NavLink
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('/admin/careers-semesters/') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                  ...
                  <NavLink
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('/admin/subjects') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <NavLink
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('/admin/enrollment/') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                <li>
                  <NavLink
                    to="/admin/user-list"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      (pathname.includes('/admin/user-list')||(pathname.includes('/admin/users'))) && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
            ...
            <>
              ...
              <div>
                ...
                <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  <li>
                    <NavLink to="/teachers/grades" className={`group relative flex items-center gap-2.5 py-2 px-4 text-[13px] duration-300 ease-in-out hover:bg-[#EDE9FE] hover:text-[#6D28D9] dark:hover:bg-meta-4 ${pathname.includes('/teachers/grades') || pathname.includes('/calificaciones') ? 'bg-[#EDE9FE] text-[#6D28D9] border-l-[3px] border-[#6D28D9] font-semibold' : 'text-[#374151] font-medium dark:text-bodydark1'}`}>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
              ...
              <div>
                ...
                <ul className="mb-6 flex flex-col gap-1.5">
                  <li>
                    <NavLink to="/teachers/rubrics/create" className={`group relative flex items-center gap-2.5 py-2 px-4 text-[13px] duration-300 ease-in-out hover:bg-[#EDE9FE] hover:text-[#6D28D9] dark:hover:bg-meta-4 ${pathname.includes('/teachers/rubrics/create') ? 'bg-[#EDE9FE] text-[#6D28D9] border-l-[3px] border-[#6D28D9] font-semibold' : 'text-[#374151] font-medium dark:text-bodydark1'}`}>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
