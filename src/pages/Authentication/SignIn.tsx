                    ...
                    <button 
                      ...
                      <span>
                        ...
                        >
                          <g clipPath="url(#clip0_191_13499)">
                            <path
                              d="M12 0.296997C5.37 0.296997 0 5.67 0 12.308C0 17.674 3.438 22.192 8.205 23.876C8.805 23.976 9.025 23.626 9.025 23.326C9.025 23.056 9.015 22.326 9.01 21.336C5.672 22.086 4.968 19.776 4.968 19.776C4.422 18.386 3.633 18.036 3.633 18.036C2.546 17.306 3.717 17.316 3.717 17.316C4.922 17.406 5.555 18.556 5.555 18.556C6.635 20.406 8.364 19.876 9.05 19.586C9.15 18.806 9.467 18.276 9.817 17.976C7.145 17.676 4.344 16.616 4.344 11.936C4.344 10.596 4.809 9.496 5.579 8.626C5.444 8.326 5.039 7.026 5.709 5.226C5.709 5.226 6.749 4.896 9.009 6.486C9.99 6.216 11.03 6.086 12.07 6.086C13.11 6.086 14.15 6.216 15.13 6.486C17.39 4.896 18.43 5.226 18.43 5.226C19.1 7.026 18.695 8.326 18.56 8.626C19.33 9.496 19.795 10.596 19.795 11.936C19.795 16.626 16.99 17.666 14.31 17.956C14.74 18.326 15.11 19.046 15.11 20.156C15.11 21.746 15.095 22.996 15.095 23.326C15.095 23.626 15.315 23.986 15.915 23.876C20.682 22.192 24.12 17.674 24.12 12.308C24.12 5.67 18.75 0.296997 12 0.296997Z"
                              fill="#FFFFFF"
                            />
                          </g>
                          <defs>
